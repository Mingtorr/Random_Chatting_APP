...
export default class Womangroup extends React.Component{
    render(){
        return(
            <View style={{display:'flex',flexDirection:'row',height:110,borderWidth:1,borderRadius:24,borderColor:'#f3525299',marginLeft:5,marginRight:5,marginBottom:5,marginTop:5}}>
            ...
            <View style={{display:'flex',flex:0.2,flexDirection:'column'}}>
                ...
                <View style={{display:'flex',flex:0.7,flexDirection:'column',justifyContent:'center'}}>
                    <TouchableOpacity>
                        <Text style={{color:'#f3525299',fontWeight:'bold',fontSize:15}}>과팅신청</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
