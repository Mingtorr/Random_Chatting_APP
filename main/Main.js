...
//////////////////////////////////////////////////////////////////////////
  ...
  rendermessage = ({item, index}) => {
    ...
    if (item.user_nickname === this.state.user_nickname) {
      ...
      return <Main_Yourmessage nickname={item.user_nickname} message={message_time} time={item.allmessage_time} />;
    }
  };
      ...
      <SafeAreaView style={styles.Container_main}
        ...
        <SafeAreaView style={{position: 'absolute', height: '100%', width: '100%'}}>
          <Animated.View style={{flex: 1, opacity: this.state.value}}>
            ...
            <View style={{flex: 0.1, flexDirection:"row", justifyContent: 'center', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: 'black'}}>
            ...
            <View style={{display: "flex", backgroundColor: 'white', flexDirection: 'row', justifyContent: 'center'}}>
              <TextInput value={this.state.my_all_message} id="my_all_message" onChangeText={(text) => this.setState({my_all_message: text})} style={styles.text_input}/>
        ...
        <Animated.View style={{ backgroundColor: 'transparent', height: this.state.animatedValue, opacity: this.state.animatedValue_back}}>
