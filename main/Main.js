...
import { Button,FlatList, View, Text, TouchableOpacity, StyleSheet,Animated } from 'react-native';
...
export default class Main extends Component {
    ...
    render() {
        return (
            <SafeAreaView style={styles.Container_main} onLayout={(event) => {
                ...
                <Animated.View style={{backgroundColor:'transparent',height:this.state.animatedValue}} >
                    <View style={{flex:0.2}}>
                        <View style={{flex:0.5,justifyContent:'flex-end',alignItems:'center'}}>
                            <Text style={{fontSize:20,color:"#f05052",fontFamily:"Jalnan"}}>창원대 소통앱</Text>
                        </View>
                        <View style={{flex:0.5,alignItems:'center'}}>
                            <Text style={{fontSize:40,color:"#f05052",fontFamily:"Jalnan"}}>와글 와글</Text>
                        </View>
                    </View>
                    <View style={{flex:0.7}}>
