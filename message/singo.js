            ...
            <SafeAreaView style={styles.idpw_bg}>
                ...
                <View style={styles.idpw_content}>
                    ...
                    <View style={styles.idpw_2}>
                        ...
                        <Text style={styles.Intro_idpw4}>빠른 시일 내에 제재하겠습니다.</Text>
                    </View>
                    ...
                    <View>
                        ...
                        <View style={styles.idpw_3}>
                            <View style={styles.Text_idpw}>
                                ...
                                multiline={true}
                                numberOfLines={4} value={this.state.email} />
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.idpw_5}>
                        <TouchableOpacity style={{
                            ...
                            <Text style={{color:'white',fontFamily:'Jalnan',fontSize:20}}>신고하기</Text>
                        </TouchableOpacity>
                    </View>
