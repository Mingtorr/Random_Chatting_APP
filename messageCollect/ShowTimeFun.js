...
export default class ShowTimeFun extends React.Component{
  render(){
    if(this.props.year ==! this.props.item.year){
      return(
        <View>
          <Text style = {styles.timeFont}>{this.props.item.year}-{this.props.item.month}-{this.props.item.day}</Text>
        </View>
      )
    }
      ...
      if (this.props.item.min > 10){
        return(
          <View>
            <Text style = {styles.timeFont}>{this.props.item.ampm} {this.props.item.hour}:{this.props.item.min}</Text>
          </View>
        )
      }else{
        return(
          <View>
              <Text style = {styles.timeFont}>{this.props.item.ampm} {this.props.item.hour}:0{this.props.item.min}</Text>
          </View>
        )
      }
